    ...
    class Validation {
        ...
        public function pattern($name){
            ...
            if($name == 'array'){
                ...
                if(!is_array($this->value)){
                    $this->errors[] = 'The format for '. $this-> name.' is invalid.';
                }
        ...
        public function required(){
            ...
            if((isset($this->file) && $this->file['error'] == 4) || ($this->value == '' || $this->value == null)){
                $this->errors[] = 'The '.$this->name.' is compulsory.';
            }            
            return $this;
        ...
        public function min($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) < $length){
                    $this->errors[] = 'The '. $this-> name.' is less than the minimum value';
                }
        ...
        public function max($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) > $length){
                    $this->errors[] = 'The '. $this-> name.' is higher than the maximum value';
                }
        ...
        public function equal($value){
            ...
            if($this->value != $value){
                $this->errors[] = 'The '. $this-> name.' is not matching.';
            }
            return $this;
